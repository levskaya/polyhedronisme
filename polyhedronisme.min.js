const{random,round,floor,sqrt,sin,cos,tan,asin,acos,atan,abs,pow,log,PI,LN10}=Math,log10=e=>log(e)/LN10,sigfigs=function(e,n){const s=pow(10,log10(e)-floor(log10(e)));return`${round(s*pow(10,n-1))}`};var clone=function(e){if(null==e||"object"!=typeof e)return e;const n=new e.constructor;for(let s in e)n[s]=clone(e[s]);return n};const randomchoice=function(e){const s=floor(random()*e.length);return e[s]},mult=(e,n)=>[e*n[0],e*n[1],e*n[2]],_mult=(e,n)=>[e[0]*n[0],e[1]*n[1],e[2]*n[2]],add=(e,n)=>[e[0]+n[0],e[1]+n[1],e[2]+n[2]],sub=(e,n)=>[e[0]-n[0],e[1]-n[1],e[2]-n[2]],dot=(e,n)=>e[0]*n[0]+e[1]*n[1]+e[2]*n[2],cross=(e,n)=>[e[1]*n[2]-e[2]*n[1],e[2]*n[0]-e[0]*n[2],e[0]*n[1]-e[1]*n[0]],mag=e=>sqrt(dot(e,e)),mag2=e=>dot(e,e),unit=e=>mult(1/sqrt(mag2(e)),e),midpoint=(e,n)=>mult(1/2,add(e,n)),tween=(e,n,s)=>[(1-s)*e[0]+s*n[0],(1-s)*e[1]+s*n[1],(1-s)*e[2]+s*n[2]],oneThird=(e,n)=>tween(e,n,1/3),reciprocal=e=>mult(1/mag2(e),e),tangentPoint=function(e,n){const s=sub(n,e);return sub(e,mult(dot(s,e)/mag2(s),s))},edgeDist=(e,n)=>sqrt(mag2(tangentPoint(e,n))),linePointDist2=function(e,n,s){let a;const i=sub(n,e),c=sub(e,s),d=sub(n,s),f=mag2(i),l=-dot(c,i)/f;return a=0>=l?mag2(c):1<=l?mag2(d):mag2(cross(i,c))/f,a},orthogonal=function(e,n,s){const a=sub(n,e),i=sub(s,n);return cross(a,i)},intersect=function(e,n,s){for(let a of e)for(let e of n)if(a===e)for(let e of s)if(a===e)return a;return null},calcCentroid=function(e){let n=[0,0,0];for(let s of e)n=add(n,s);return mult(1/e.length,n)},normal=function(e){let n=[0,0,0],[s,a]=e.slice(-2);for(let i of e)n=add(n,orthogonal(s,a,i)),[s,a]=[a,i];return unit(n)},planararea=function(e){let n=0,s=[0,0,0],[a,i]=e.slice(-2);for(let n of e)s=add(s,cross(a,i)),[a,i]=[i,n];return n=abs(dot(normal(e),s)/2),n},faceSignature=function(e,n){let s;const a=[];let[i,c]=e.slice(-2);for(let s of e)a.push(mag(cross(sub(i,c),sub(s,c)))),[i,c]=[c,s];a.sort((e,n)=>e-n);let d="";for(s of a)d+=sigfigs(s,n);for(s of a.reverse())d+=sigfigs(s,n);return d},project2dface=function(e){let s=clone(e);const a=e[0];s=_.map(s,e=>e-a);const i=normal(e),n=unit(calcCentroid(e)),c=cross(i,n);return s.map(e=>[dot(i,e),dot(c,e)])},copyVecArray=function(e){const n=Array(e.length);for(let s=0,a=e.length;s<a;s++)n[s]=e[s].slice(0);return n},mv3=(e,n)=>[e[0][0]*n[0]+e[0][1]*n[1]+e[0][2]*n[2],e[1][0]*n[0]+e[1][1]*n[1]+e[1][2]*n[2],e[2][0]*n[0]+e[2][1]*n[1]+e[2][2]*n[2]],mm3=(e,n)=>[[e[0][0]*n[0][0]+e[0][1]*n[1][0]+e[0][2]*n[2][0],e[0][0]*n[0][1]+e[0][1]*n[1][1]+e[0][2]*n[2][1],e[0][0]*n[0][2]+e[0][1]*n[1][2]+e[0][2]*n[2][2]],[e[1][0]*n[0][0]+e[1][1]*n[1][0]+e[1][2]*n[2][0],e[1][0]*n[0][1]+e[1][1]*n[1][1]+e[1][2]*n[2][1],e[1][0]*n[0][2]+e[1][1]*n[1][2]+e[1][2]*n[2][2]],[e[2][0]*n[0][0]+e[2][1]*n[1][0]+e[2][2]*n[2][0],e[2][0]*n[0][1]+e[2][1]*n[1][1]+e[2][2]*n[2][1],e[2][0]*n[0][2]+e[2][1]*n[1][2]+e[2][2]*n[2][2]]],eye3=[[1,0,0],[0,1,0],[0,0,1]],rotm=function(e,n,s){const a=[[cos(e),-1*sin(e),0],[sin(e),cos(e),0],[0,0,1]],i=[[cos(n),0,-1*sin(n)],[0,1,0],[sin(n),0,cos(n)]],c=[[1,0,0],[0,cos(s),-1*sin(s)],[0,sin(s),cos(s)]];return mm3(c,mm3(i,a))},vec_rotm=function(e,n,s,a){let i;e/=2;const c=sin(e),d=cos(e),f=c*c,t=mag([n,s,a]);if(0===t&&([n,s,a]=[0,0,1]),1!==t&&([n,s,a]=unit([n,s,a])),1===n&&0===s&&0===a)i=[[1,0,0],[0,1-2*f,2*c*d],[0,-2*c*d,1-2*f]];else if(0===n&&1===s&&0===a)i=[[1-2*f,0,-2*c*d],[0,1,0],[2*c*d,0,1-2*f]];else if(0===n&&0===s&&1===a)i=[[1-2*f,2*c*d,0],[-2*c*d,1-2*f,0],[0,0,1]];else{const e=n*n,t=s*s,l=a*a;i=[[1-2*(t+l)*f,2*(n*s*f+a*c*d),2*(n*a*f-s*c*d)],[2*(s*n*f-a*c*d),1-2*(l+e)*f,2*(s*a*f+n*c*d)],[2*(a*n*f+s*c*d),2*(a*s*f-n*c*d),1-2*(e+t)*f]]}return i},perspT=function(e,n,s,a,i){const c=(n*a-s)/(1-a),d=i*a/(1-a);return[d*e[0]/(e[2]+c),d*e[1]/(e[2]+c)]},invperspT=function(e,n,a,i,c,d,f,t){const l=(c*f-d)/(1-f),r=t*f/(1-f),s=e-a,u=n-i,v=r*r,g=l*l,m=s*s,o=u*u,J=(2*r*s*l+sqrt(4*v*m*g+4*m*(v+m+o)*(1-g)))/(2*(v+m+o)),p=r*u*l/(v+m+o)+u*sqrt(4*v*g+4*(v+m+o)*(1-g))/(2*(v+m+o)),h=sqrt(1-J*J-p*p);return[J,p,h]},getVec2VecRotM=function(e,n){const s=cross(e,n),a=acos(dot(e,n));return vec_rotm(-1*a,s[0],s[1],s[2])};function __range__(e,n,s){let a=[],c=e<n,d=s?c?n+1:n-1:n;for(let f=e;c?f<d:f>d;c?f++:f--)a.push(f);return a}const faceToEdges=function(e){const n=[];let[s]=e.slice(-1);for(let a of e)n.push([s,a]),s=a;return n},vertColors=function(e){const n=[];for(let s=0;s<e.faces.length;s++){const a=e.faces[s];for(let i of a)n[i]=e.face_classes[s]}return n},rwb_palette=["#ff7777","#dddddd","#889999","#fff0e5","#aa3333","#ff0000","#ffffff","#aaaaaa"];function hsl2rgb(e,n,s){let a,i,c;if(0==n)a=i=c=s;else{const d=function(e,n,s){return 0>s&&(s+=1),1<s&&(s-=1),s<1/6?e+6*(n-e)*s:s<1/2?n:s<2/3?e+6*((n-e)*(2/3-s)):e};let f=.5>s?s*(1+n):s+n-s*n,t=2*s-f;a=d(t,f,e+1/3),i=d(t,f,e),c=d(t,f,e-1/3)}return[a,i,c]}const hextofloats=function(e){let n;return"#"===e[0]&&(e=e.slice(1)),n=3===e.length?e.split("").map(e=>parseInt(e+e,16)/255):e.match(/.{2}/g).map(e=>parseInt(e,16)/255),n},floatstohex=function(e){let n=(+parseInt(255*e[0],10)).toString(16),s=(+parseInt(255*e[1],10)).toString(16),a=(+parseInt(255*e[2],10)).toString(16);return"#"+n+s+a},rndcolors=function(){let e=[];for(let n=0;100>n;n++){let n=random(),a=.5*random()+.3,s=.5*random()+.45,i=hsl2rgb(n,a,s);e.push(floatstohex(i))}return e};let PALETTE=rwb_palette;const palette=function(e){const n=e%PALETTE.length;return hextofloats(PALETTE[n])},paintPolyhedron=function(e){e.face_classes=[];const n={},s=function(e,n){if(e in n)return n[e];else{const s=_.toArray(n).length;return n[e]=s,s}};for(var a of e.faces){var i,c;"area"===COLOR_METHOD?(c=a.map(n=>e.vertices[n]),i=s(sigfigs(planararea(c),COLOR_SENSITIVITY),n)):"signature"===COLOR_METHOD?(c=a.map(n=>e.vertices[n]),i=s(faceSignature(c,COLOR_SENSITIVITY),n)):i=a.length-3,e.face_classes.push(i)}return console.log(_.toArray(n).length+" face classes"),e},sortfaces=function(e){const n=e.centers(),s=e.normals(),a=[0,0,(persp_z_max*persp_ratio-persp_z_min)/(1-persp_ratio)],i=_.zip(n,s,__range__(0,e.faces.length,!1)).sort((e,n)=>e[0][2]-n[0][2]).map(e=>e[2]);e.faces=i.map(n=>e.faces[n]),e.face_classes=i.map(n=>e.face_classes[n])};class polyhedron{constructor(e,n,s){this.faces=n||[],this.vertices=e||[],this.name=s||"null polyhedron"}data(){const e=this.faces.length+this.vertices.length-2;return`${this.faces.length} faces, ${e} edges, ${this.vertices.length} vertices`}edges(){let n,s,i;const c={},d=[],f=_.map(this.faces,faceToEdges);for(let e of f)for(n of e)n[0]<n[1]?[s,i]=n:[i,s]=n,c[s+"~"+i]=n;for(let e in c)n=c[e],d.push(n);return d}centers(){const e=[];for(let n of this.faces){let s=[0,0,0];for(let e of n)s=add(s,this.vertices[e]);e.push(mult(1/n.length,s))}return e}normals(){const e=[];for(let n of this.faces)e.push(normal(n.map(e=>this.vertices[e])));return e}moreData(){return`min. edge length ${this.minEdgeLength().toPrecision(2)}; `+`min. face radius ${this.minFaceRadius().toPrecision(2)}`}minEdgeLength(){let n=Number.MAX_VALUE;for(let s of this.edges()){const e=mag2(sub(this.vertices[s[0]],this.vertices[s[1]]));e<n&&(n=e)}return sqrt(n)}minFaceRadius(){let n=Number.MAX_VALUE;const s=this.faces.length,a=this.centers();for(let i=0;i<s;i++){const s=a[i];for(let a of faceToEdges(this.faces[i])){const e=linePointDist2(this.vertices[a[0]],this.vertices[a[1]],s);e<n&&(n=e)}}return sqrt(n)}toOBJ(){let e,n,s="#Produced by polyH\xE9dronisme http://levskaya.github.com/polyhedronisme\n";s+=`group ${this.name}\n`,s+="#vertices\n";for(n of this.vertices)s+=`v ${n[0]} ${n[1]} ${n[2]}\n`;s+="#normal vector defs \n";for(e of this.faces){const n=normal(e.map(e=>this.vertices[e]));s+=`vn ${n[0]} ${n[1]} ${n[2]}\n`}s+="#face defs \n";for(let a=0;a<this.faces.length;a++){e=this.faces[a],s+="f ";for(n of e)s+=`${n+1}//${a+1} `;s+="\n"}return s}toX3D(){let e;const n=.03;let s=`\
