...
(function() {
  ...
  copyVecArray = function(vecArray) {
    ...
    for (i = l = 0, ref = vecArray.length; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
  ...
  sortfaces = function(poly) {
    ...
    zsortIndex = _.zip(centroids, normals, (function() {
      results = [];
      for (var l = 0, ref = poly.face.length; 0 <= ref ? l < ref : l > ref; 0 <= ref ? l++ : l--){ results.push(l); }
      return results;
  ...
  prism = function(n) {
    ...
    poly.face.push((function() {
      results1 = [];
      for (var w = n, ref3 = 2 * n; n <= ref3 ? w < ref3 : w > ref3; n <= ref3 ? w++ : w--){ results1.push(w); }
      return results1;
    }).apply(this));
    for (i = aa = 0, ref4 = n; 0 <= ref4 ? aa < ref4 : aa > ref4; i = 0 <= ref4 ? ++aa : --aa) {
  ...
  hollow = function(poly, n, inset_dist, thickness) {
    var aa, centers, dualnormals, f, flag, fname, foundAny, i, l, len, len1, len2, len3, len4, newpoly, normals, o, p, ref, ref1, ref2, u, v, v1, v2, w;
    n || (n = 0);
    inset_dist || (inset_dist = 0.5);
  ...
  canonicalXYZ = function(poly, nIterations) {
    ...
    for (count = l = 0, ref = nIterations; 0 <= ref ? l < ref : l > ref; count = 0 <= ref ? ++l : --l) {
